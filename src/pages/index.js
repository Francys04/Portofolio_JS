...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>AlexMorohai_Portofolio</title>
        <meta
          name="description"
        ...
        <Layout className="!pt-0 md:!pt-16 sm:!pt-16">
          <div className="flex w-full items-start justify-between md:flex-col">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              Hello to all the guests and welcome to the presentation of my project portfolio. These projects reflect the skills and desire for development in the IT field with the help of Python, JavaScript and Database programming languages. The challenges in IT helped me to understand how many development possibilities this field can offer me.
              </p>
            ...
            md:p-2 md:px-4 md:text-base
             `}
                ...
                <Link
                  href="mailto:alexmorohai1997@gmail.com"
